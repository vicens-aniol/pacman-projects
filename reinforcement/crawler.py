...
#        self.angleSums.append(abs(math.degrees(old_arm_angle)-math.degrees(new_arm_angle)))
 ...
 #           self.angleSums.pop(0)
    ...
    def move_hand(self, new_hand_angle):
        ...
        # Position and Velocity Sign Post
        self.positions.append(self.get_robot_position()[0])
 #       self.angleSums.append(abs(math.degrees(old_hand_angle)-math.degrees(new_hand_angle)))
        if len(self.positions) > 100:
            self.positions.pop(0)
 #           self.angleSums.pop(0)
